...
regionId int NOT NULL
        ...
        $sql = 'CREATE TABLE IF NOT EXISTS nation ( 
countryId int NOT NULL AUTO_INCREMENT PRIMARY KEY,
countryName varchar(40) NOT NULL DEFAULT \'New Zealand\',
regionId int NOT NULL
);';
        query($sql);
        ?>
        ...
        <?php
        $sql = 'ALTER TABLE nation RENAME country;';
        query($sql);
        ?>
        ...
        <?php
        $sql = 'INSERT INTO country VALUES(null,\'Australia\',100),  
(null,\'USA\',1007),(null,\'UK\',1003);';
        query($sql);
        ?>
