...
<html>
    ...
    <body>
        ...
        <?php
        $sql = 'SELECT last_modified_on "Last Modified" FROM todo;';
        displayRowInfo($sql,1);
        ?>
        ...
        <?php
        $sql = 'SELECT COUNT(DISTINCT priority) FROM todo;';
        displayRowInfo($sql,8);
        ?>
